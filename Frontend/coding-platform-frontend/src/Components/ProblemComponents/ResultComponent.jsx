    ...
    const getStatusClasses = () => {
      ...
      return (
        <div className="status-component border rounded-md p-4 mb-4">
          ...
          { props.data.status === "Error"  ? ((props.data.message.error).substring(props.data.message.error.indexOf('line') , )) : (`Actual: ${props.data.Actual}  Expected : ${props.data.Expected}`)}
          </div>
        </div>
      );
    };
